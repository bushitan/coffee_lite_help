...
class Admin {
    ...
    async getList(data) { 
        ...
        var res = await this.callFunction( "manager" ,data)
    ...
    async updateSN(model,json){
        ...
        try {
            ...
            var res = await this.callFunction( "manager" ,{ model:model ,  action: "updateSN", snJson :json  })

            wx.hideLoading()

            var result = res.result
            wx.showModal({ title: result.msg,  showCancel:false, })
    ...
    async getNode(model , _id){
        ...
        // })
        wx.showLoading({ mask:true })
        var res = await this.callFunction( "manager" ,{ model:model ,  action: "getNode", _id :_id  })        
        wx.hideLoading()
        return res.result
    }
    ...
    async addNode(model){
        ...
        wx.showLoading({ mask:true })
        var res = await this.callFunction( "manager" ,{ model:model ,  action: "addNode" })        
        wx.hideLoading()
        return res.result
    }
    ...
    async updateNode(model,_id,node){
        ...
        wx.showLoading({ mask:true })
        var res = await this.callFunction( "manager" ,{ model:model ,  action: "updateNode", _id :_id , node:node })        
        wx.hideLoading()
        return res.result 
    }
